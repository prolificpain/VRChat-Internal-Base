...
namespace WorldAPI.ButtonAPI.Extras
{
    public static class QMUtils
    {
        ...
        public static MenuStateController GetMainMenuStateControllerInstance => null; //GetMainMenuInstance.GetComponent<MenuStateController>();
        ...
        public static TextMeshProUGUI AddTextMeshProComponent(GameObject obj)
        {
            GameObject game = new GameObject("Holy Fuck");
            game.transform.parent = obj.transform.parent;
            game.transform.localPosition = new Vector3(0, -22, 0);
            game.transform.localScale = Vector3.one;
            game.transform.rotation = new Quaternion();

            TextMeshProUGUI newTextMeshPro = game.AddComponent<TextMeshProUGUI>();
            newTextMeshPro.fontSize = 27f;
            newTextMeshPro.fontStyle = FontStyles.Bold;
            newTextMeshPro.color = new Color(0.3294f, 0.5098f, 0.5412f, 1f);
